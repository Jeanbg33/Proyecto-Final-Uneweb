Se realizó una plataforma de marketplace moderna desarrollada en Python/Django para la venta de productos digitales. Proyecto final del Diplomado en Programación Python y Bases de Datos de UNEWEB.
